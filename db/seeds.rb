...
# Inventory.create(product_id: 62, warehouse_id: Warehouse.first.id, item_count:1111 , low_item_threshold:150)
# Inventory.create(product_id: 62, warehouse_id: Warehouse.second.id, item_count:111 , low_item_threshold:150)
# Inventory.create(product_id: 62, warehouse_id: Warehouse.third.id, item_count:2222 , low_item_threshold:150)
# Inventory.create(product_id: 62, warehouse_id: Warehouse.fourth.id, item_count:0 , low_item_threshold:10)
# Inventory.create(product_id: 62, warehouse_id: Warehouse.fifth.id, item_count:0 , low_item_threshold:10)